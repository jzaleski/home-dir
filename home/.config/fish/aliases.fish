...
alias goal='env DATABASE_NAME="GOALS" list-cli';
alias htop='~/lib/htop.sh';
alias icebox='env DATABASE_NAME="ICEBOX" list-cli';
...
alias note='env DATABASE_NAME="NOTES" list-cli';
alias psql='~/lib/psql.sh';
alias pypi='~/lib/pypi.sh';
alias question='env DATABASE_NAME="QUESTIONS" list-cli';
