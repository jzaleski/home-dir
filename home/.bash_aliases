...
alias goal='LIST_NAME="GOALS" ~/lib/list.py';
alias htop='~/lib/htop.sh';
alias icebox='LIST_NAME="ICEBOX" ~/lib/list.py';
...
alias note='LIST_NAME="NOTES" ~/lib/list.py';
alias psql='~/lib/psql.sh';
alias question='LIST_NAME="QUESTIONS" ~/lib/list.py';
