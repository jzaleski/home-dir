...
# comment_lines - markdown2latex - escape_latex - add_anchor - ipython2python -
# posix_path - highlight2latex - path2url - ansi2html - wrap_text - indent -
# strip_dollars - html2text - strip_files_prefix
...
# An ordered list of prefered output type, the first encounterd will usually be
# used when converting discarding the others.
# c.CSSHTMLHeaderPreprocessor.display_data_priority = ['html', 'pdf', 'svg', 'latex', 'png', 'jpg', 'jpeg', 'text']
...
# An ordered list of prefered output type, the first encounterd will usually be
# used when converting discarding the others.
# c.ConvertFiguresPreprocessor.display_data_priority = ['html', 'pdf', 'svg', 'latex', 'png', 'jpg', 'jpeg', 'text']
...
# 
# c.ExtractOutputPreprocessor.extract_output_types = set(['pdf', 'jpg', 'png', 'svg'])
...
# An ordered list of prefered output type, the first encounterd will usually be
# used when converting discarding the others.
# c.ExtractOutputPreprocessor.display_data_priority = ['html', 'pdf', 'svg', 'latex', 'png', 'jpg', 'jpeg', 'text']
...
# An ordered list of prefered output type, the first encounterd will usually be
# used when converting discarding the others.
# c.HighlightMagicsPreprocessor.display_data_priority = ['html', 'pdf', 'svg', 'latex', 'png', 'jpg', 'jpeg', 'text']
...
# An ordered list of prefered output type, the first encounterd will usually be
# used when converting discarding the others.
# c.LatexPreprocessor.display_data_priority = ['html', 'pdf', 'svg', 'latex', 'png', 'jpg', 'jpeg', 'text']
...
# An ordered list of prefered output type, the first encounterd will usually be
# used when converting discarding the others.
# c.Preprocessor.display_data_priority = ['html', 'pdf', 'svg', 'latex', 'png', 'jpg', 'jpeg', 'text']
...
# An ordered list of prefered output type, the first encounterd will usually be
# used when converting discarding the others.
# c.RevealHelpPreprocessor.display_data_priority = ['html', 'pdf', 'svg', 'latex', 'png', 'jpg', 'jpeg', 'text']
...
# An ordered list of prefered output type, the first encounterd will usually be
# used when converting discarding the others.
# c.SVG2PDFPreprocessor.display_data_priority = ['html', 'pdf', 'svg', 'latex', 'png', 'jpg', 'jpeg', 'text']
...
# An ordered list of prefered output type, the first encounterd will usually be
# used when converting discarding the others.
# c.PDFPostProcessor.display_data_priority = ['html', 'pdf', 'svg', 'latex', 'png', 'jpg', 'jpeg', 'text']
...
# An ordered list of prefered output type, the first encounterd will usually be
# used when converting discarding the others.
# c.PostProcessorBase.display_data_priority = ['html', 'pdf', 'svg', 'latex', 'png', 'jpg', 'jpeg', 'text']
